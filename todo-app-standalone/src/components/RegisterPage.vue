        ...
        <div class="custom-row">
            <div class="custom-col">
                ...
                <div class="custom-card">
                    <h2 class="custom-card-title">{{ $t('register') }}</h2>
                    <form class="custom-card-content">
                        ...
                        <div class="custom-form-group">
                            <Password v-model="password" toggleMask promptLabel="Enter your password" weakLabel="Very Weak" mediumLabel="Medium" strongLabel="Strong" :placeholder="$t('password')">password</Password>
                        </div> 
                            <button @click.prevent.stop="registerUser" class="my-register-button">{{ $t('submit') }}</button>
                    </form>
                    <div class="custom-card-footer">
                        <button @click="$router.push('/login')" class="my-login-button">{{$t('login') }}</button>
                    </div>
                </div>
            </div>
        </div>
